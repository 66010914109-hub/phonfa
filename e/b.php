...
<body>
    <div class="main-card animate-on-load">
        ...
        <div class="p-5">
                <form action="../../../Users/Administrator/Downloads/f.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="text-center mt-5">
                    ...
                    <p class="text-muted mt-3 small">เมื่อกดส่ง ข้อมูลจะถูกบันทึกเข้าสู่ระบบฐานข้อมูลของพรฟ้ากรุ๊ป</p>
                </div>
            </form>
        </div>
    </div>
